...
exports.registerUser = catchAsync(async (req, res, next) => {
  // enviamos por el body el nombre y la contraseña a registrar
  const { name, password } = req.body;

  // importamos el generador de cuentas de la carpeta utils
  const accountNumber = accountNumberGenerator();

  // importamos y usamos el bcrypt para encryptar una contraseña
